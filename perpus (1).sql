...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2024 at 03:20 AM
...
(21, '2024_04_22_132211_add_rent_log_id_to_ulasan_buku_table', 2);
...
(1, 1, 8, '2024-04-02', '2024-04-22', '2024-04-05', 'dikembalikan', '2024-04-01 23:46:50', '2024-04-22 01:58:06'),
(2, 2, 8, '2024-04-22', '2024-04-22', '2024-04-25', 'dikembalikan', '2024-04-22 01:59:26', '2024-04-22 02:00:03'),
(3, 3, 8, '2024-04-22', '2024-04-22', '2024-04-25', 'dikembalikan', '2024-04-22 01:59:36', '2024-04-22 07:01:23'),
(4, 1, 8, '2024-04-22', '2024-04-22', '2024-04-25', 'dikembalikan', '2024-04-22 01:59:42', '2024-04-22 02:00:09'),
(5, 2, 8, '2024-04-22', NULL, '2024-04-25', 'dipinjam', '2024-04-22 06:09:43', '2024-04-22 06:09:43'),
(6, 3, 9, '2024-04-22', NULL, '2024-04-25', 'dipinjam', '2024-04-22 08:39:57', '2024-04-22 08:39:57'),
(7, 1, 8, '2024-04-23', NULL, '2024-04-26', 'dipinjam', '2024-04-22 19:20:14', '2024-04-22 19:20:14');
...
CREATE TABLE `ulasan_buku` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `rent_log_id` bigint(20) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `ulasan_buku` (`id`, `user_id`, `books_id`, `ulasan`, `rating`, `created_at`, `updated_at`, `rent_log_id`) VALUES
(1, 8, 3, 'good', 4, '2024-04-22 06:56:35', '2024-04-22 06:56:35', 3),
(2, 8, 3, 'ok', 4, '2024-04-22 06:56:59', '2024-04-22 06:56:59', 3),
(3, 8, 2, 'rr', 2, '2024-04-22 07:13:19', '2024-04-22 07:13:19', 2),
(4, 8, 2, 'gi', 5, '2024-04-22 07:13:33', '2024-04-22 07:13:33', 5);
...
(9, 'qori1', 'qori1', 'qoriii', '$2y$10$fGSL08hPiDeUUdSWvfMWxOPau9RxAXsI2P2CiLbjJwqhg7kCbxk2K', 'qori1@gmail.com', 'rumahh', 'active', 2, '2024-04-22 07:27:52', '2024-04-22 10:11:39', NULL);
...
ALTER TABLE `ulasan_buku`
  ...
  ADD KEY `ulasan_buku_rent_log_id_foreign` (`rent_log_id`);
...
ALTER TABLE `ulasan_buku`
  ...
  ADD CONSTRAINT `ulasan_buku_rent_log_id_foreign` FOREIGN KEY (`rent_log_id`) REFERENCES `rent_logs` (`id`) ON DELETE CASCADE,
